...
def crop_recommend():
    title = 'SmartAgri - Crop Recommendation'
    heading='What crop to plant???'
    subheading='Find out the most suitable crop to grow in your farm'
...
def fertilizer_recommendation():
    ...
    title = 'SmartAgri - Fertilizer Suggestion'
    heading='Which Fertilizer to use???'
    subheading='Get informed advice on fertilizer based on soil'
...
def disease_prediction():
    title = 'SmartAgri - Disease Detection'
    heading='Want to know which disease affects your plant???'
    subheading=''
